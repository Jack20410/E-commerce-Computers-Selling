                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=250&q=80"
                      alt="Customer"
                    />
                  </div>
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Sarah T.</h3>
                    <p className="text-gray-500">Gaming Enthusiast</p>
                  </div>
                </div>
                <div className="mt-4 text-gray-600">
                  <p>
                    "The gaming PC I bought exceeded my expectations. The build quality is excellent, and the performance is incredible for the price. Customer support was also very helpful."
                  </p>
                </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <img
                      className="h-12 w-12 rounded-full"
                      src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=250&q=80"
                      alt="Customer"
                    />
                  </div>
                  <div className="ml-4">
                ...
                <div className="mt-4 text-gray-600">
                  <p>
                    "I've bought all my workstation components from TechStation. The prices are competitive, and the delivery is always fast. My go-to store for all computer parts."
                  </p>
                </div>
                <div className="mt-4 flex text-yellow-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <img
                      className="h-12 w-12 rounded-full"
                      src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=250&q=80"
                      alt="Customer"
                    />
                  </div>
                  <div className="ml-4">
                ...
                <div className="mt-4 text-gray-600">
                  <p>
                    "I was looking for a laptop that could handle video editing on the go. The staff recommended the perfect model for my needs, and I couldn't be happier with my purchase."
                  </p>
                </div>
                <div className="mt-4 flex text-yellow-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
