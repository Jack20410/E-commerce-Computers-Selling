    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">TechStation</h3>
            <p className="text-gray-400 text-sm">Your one-stop shop for all computer hardware needs. From pre-built PCs to individual components.</p>
          ...
          <div>
            ...
            <ul className="text-gray-400 space-y-2">
              <li><a href="#" className="hover:text-white">Pre-built PCs</a></li>
              <li><a href="#" className="hover:text-white">Laptops</a></li>
              <li><a href="#" className="hover:text-white">CPUs</a></li>
              <li><a href="#" className="hover:text-white">Graphics Cards</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-gray-400 text-sm text-center">&copy; {new Date().getFullYear()} TechStation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
