    ...
    <footer className="bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-900">TechStation</h3>
            <p className="text-gray-600 text-sm">Your one-stop shop for all computer hardware needs. From pre-built PCs to individual components.</p>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                ...
                className="px-4 py-2 bg-white border border-gray-200 text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button 
                type="submit" 
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-gray-600 text-sm text-center">&copy; {new Date().getFullYear()} TechStation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
